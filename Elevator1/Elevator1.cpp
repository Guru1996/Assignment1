...
/***************************************************************************************/
Screen elevator1_screen("elevator1_screen");
...
void intialAnimationSetup(int status) {
	...
	if (status == 1) {
		elevator1_screen.WriteToScreen(0, 2, "green", "FLOOR 9");
		elevator1_screen.WriteToScreen(0, 4, "green", "FLOOR 8");
		elevator1_screen.WriteToScreen(0, 6, "green", "FLOOR 7");
		elevator1_screen.WriteToScreen(0, 8, "green", "FLOOR 6");
		elevator1_screen.WriteToScreen(0, 10, "green", "FLOOR 5");
		elevator1_screen.WriteToScreen(0, 12, "green", "FLOOR 4");
		elevator1_screen.WriteToScreen(0, 14, "green", "FLOOR 3");
		elevator1_screen.WriteToScreen(0, 16, "green", "FLOOR 2");
		elevator1_screen.WriteToScreen(0, 18, "green", "FLOOR 1");
		elevator1_screen.WriteToScreen(0, 20, "green", "FLOOR G");
	}
	else {
		elevator1_screen.WriteToScreen(0, 2, "red", "FLOOR 9");
		elevator1_screen.WriteToScreen(0, 4, "red", "FLOOR 8");
		elevator1_screen.WriteToScreen(0, 6, "red", "FLOOR 7");
		elevator1_screen.WriteToScreen(0, 8, "red", "FLOOR 6");
		elevator1_screen.WriteToScreen(0, 10, "red", "FLOOR 5");
		elevator1_screen.WriteToScreen(0, 12, "red", "FLOOR 4");
		elevator1_screen.WriteToScreen(0, 14, "red", "FLOOR 3");
		elevator1_screen.WriteToScreen(0, 16, "red", "FLOOR 2");
		elevator1_screen.WriteToScreen(0, 18, "red", "FLOOR 1");
		elevator1_screen.WriteToScreen(0, 20, "red", "FLOOR G");
	}
}
void printvalues(int status, int current_floor, int direction, int door) {
	...
	*/
	if (status == 1) {
		elevator1_screen.WriteToScreen(0, 0, "white", "STATUS:");
		elevator1_screen.WriteToScreen(6, 0, "green", " IN SERVICE      ");
		intialAnimationSetup(status);
	}
	else {
		elevator1_screen.WriteToScreen(0, 0, "white", "STATUS");
		elevator1_screen.WriteToScreen(6, 0, "red", " OUT OF SERVICE");
		intialAnimationSetup(status);
	}
	...
	if (door == 0 && direction == 1) {
		elevator1_screen.WriteToScreen(8, 2 * (9 - current_floor), "white", "          ");
		elevator1_screen.WriteToScreen(8, 4 + 2 * (9 - current_floor), "white", "          ");
		elevator1_screen.WriteToScreen(8, 2 + 2 * (9 - current_floor), "white", "<-[--]UP   ");
	}
	else {
		if (door == 0 && direction == 2) {
			elevator1_screen.WriteToScreen(8, 2 * (9 - current_floor), "white", "          ");
			elevator1_screen.WriteToScreen(8, 4 + 2 * (9 - current_floor), "white", "          ");
			elevator1_screen.WriteToScreen(8, 2 + 2 * (9 - current_floor), "white", "<-[--]DOWN");
		}
			...
			elevator1_screen.WriteToScreen(8, 2 * (9 - current_floor), "white", "          ");
			elevator1_screen.WriteToScreen(8, 4 + 2 * (9 - current_floor), "white", "          ");
			elevator1_screen.WriteToScreen(8, 2 + 2 * (9 - current_floor), "white", "<-[--]     ");
		}
		else {
			elevator1_screen.WriteToScreen(8, 2 * (9 - current_floor), "white", "          ");
			elevator1_screen.WriteToScreen(8, 4 + 2 * (9 - current_floor), "white", "          ");
